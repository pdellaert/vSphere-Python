...
def get_args():
    ...
    parser.add_argument('-l', '--log-file', nargs=1, required=False, help='File to log to, if not specified, stdout is used', dest='logfile', type=str)
    ...
    parser.add_argument('-o', '--port', nargs=1, required=False, help='Server port to connect to', dest='port', type=int, default=[443])
    parser.add_argument('-p', '--password', nargs=1, required=False, help='The password with which to connect to the host', dest='password', type=str)
    ...
    parser.add_argument('-s', '--post-script', nargs=1, required=False, help='Script to be called after each VM is created and booted. Arguments passed: name ip-address', dest='post_script', type=str)
